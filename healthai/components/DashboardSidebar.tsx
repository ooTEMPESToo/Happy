        ...
        <div className="flex gap-3 items-center mb-4">
          {userProfile?.profile_image_url ? (
            <div
              ...
              style={{
                backgroundImage: `url("${userProfile.profile_image_url}")`,
              }}
            ></div>
          ) : (
        ...
        <div className="flex flex-col gap-2">
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors ${
              pathname === "/dashboard" ? "bg-[#f1f4f1]" : ""
            }`}
          >
            <div
              className="text-[#131712]"
              data-icon="House"
              data-size="24px"
              data-weight="fill"
            >
            ...
            <p className="text-[#131712] text-sm font-medium leading-normal">
              Dashboard
            </p>
          </Link>
          ...
          <Link
            href="/disease-prediction" // Corrected href for clarity, assuming it's different from general /prediction
            className={`flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors ${
              pathname === "/disease-prediction" ? "bg-[#f1f4f1]" : ""
            }`}
          >
            <div
              className="text-[#131712]"
          ...
          <Link
            href="/professions"
            className={`flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors ${
              pathname === "/professions" ? "bg-[#f1f4f1]" : ""
            }`}
          >
            <div
              className="text-[#131712]"
